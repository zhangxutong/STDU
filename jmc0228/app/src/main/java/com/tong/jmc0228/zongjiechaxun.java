...
public class zongjiechaxun extends AppCompatActivity implements View.OnClickListener{
    private DBUtil util;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zongjiechaxun);
        ...
        switch (view.getId()) {
            case R.id.chaxun:
                ...
                for (int i = 0; i < data.size(); i++) {
                    ...
                    if(mrzj.getZongjie().equals(chaxuntiaojian)) {
